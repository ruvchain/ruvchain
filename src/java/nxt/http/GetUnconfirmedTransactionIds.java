...
public final class GetUnconfirmedTransactionIds extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws ParameterException {
        ...
        if (accountIds.isEmpty()) {
            try (DbIterator<? extends Transaction> transactionsIterator = Ruv.getTransactionProcessor().getAllUnconfirmedTransactions(firstIndex, lastIndex)) {
            ...
            try (FilteringIterator<? extends Transaction> transactionsIterator = new FilteringIterator<> (
                    Ruv.getTransactionProcessor().getAllUnconfirmedTransactions(0, -1),
