const options = {
    url: "http://localhost:6876", // URL of RUV remote node
...
exports.load = function(callback) {
    ...
    require("jsdom").env("", function(err, window) {
        try {
            ...
            // the RUV client wasn't designed with modularity in mind therefore we need
            ...
            // Now load some RUV specific libraries into the global scope
            global.RuvAddress = require('./util/ruvaddress');
            ...
            // however the RUV client relies on a global browser scope which defines the NRS object
