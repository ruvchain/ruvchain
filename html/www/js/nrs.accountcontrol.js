...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			labelText: "Amount RUV",
			labelI18n: "amount_ruv",
			helpI18n: "approve_transaction_amount_help",
			inputName: "controlQuorumRUV",
			addonText: "RUV",
			addonI18n: "ruv_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_ruv', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalanceRUV';
		context['addonText'] = 'RUV';
		context['addonI18n'] = 'ruv_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_ruv', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
